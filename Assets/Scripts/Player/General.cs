...
public class General : Player
{
    ...
    public override void SetUp()
    {
        ...
        GameObject newHelicopter = Instantiate(helicopter, transform.position, Quaternion.identity);
        newHelicopter.GetComponent<Player>().InitPlayer(character);
    }
